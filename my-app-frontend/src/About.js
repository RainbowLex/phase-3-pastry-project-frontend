...
function About() {
  return (
    <div className="About">
      <Header />
      <h1 id="aboutTitle1">About Sam</h1>
      ...
      <h1 id="aboutTitle2">About Alexia</h1>
      ...
      <p id="bio">My name is Alexia Velador. I have spent my whole life studying Spongebob, in order to understand every reference made about the show.
      So if you also know Spongebob, then do not be afraid to test me on it and talk about it with me!</p>
      <Footer />
    </div>
  );
}
